...
const CATEGORY_COLORS: { [key: string]: string } = {
  ...
  success: 'bg-[rgb(200,255,200)]',
  motivation: 'bg-[rgb(255,220,180)]',
  wisdom: 'bg-purple',
  humor: 'bg-secondary-light',
  friendship: 'bg-[rgb(200,255,200)]',
  family: 'bg-peach',
  system: 'bg-gray-100',
};
    ...
    <div className={`card-soft-brutalism ${categoryColor} group h-full flex flex-col relative`}>
      ...
      <div className="flex gap-2 items-center">
        <button
          ...
          className={`p-2.5 border-2 border-[rgb(30,30,40)] rounded-lg transition-all duration-200 ${
            isLiked 
        ...
        <button
          onClick={handleCopy}
          className="p-2.5 border-2 border-[rgb(30,30,40)] rounded-lg bg-white hover:bg-gray-50 hover:shadow-soft-sm transition-all duration-200 ml-auto"
        ...
        <div className="relative">
          <button
            ...
            className="p-2.5 border-2 border-[rgb(30,30,40)] rounded-lg bg-white hover:bg-gray-50 hover:shadow-soft-sm transition-all duration-200"
          ...
          {/* Share Menu */}
          {showShareMenu && (
            <div className="absolute right-0 bottom-full mb-2 card-soft-brutalism bg-white p-2 min-w-[160px] z-10">
              <button
                onClick={() => handleShare('twitter')}
                className="w-full flex items-center gap-2 px-3 py-2 hover:bg-gray-100 rounded-lg text-sm font-medium transition-colors"
              >
